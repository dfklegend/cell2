    ...
    public class EnumUtil
    {
        ...
        public static T GetEnum<T>(string str, StringComparison comparisonType)
        {
            ...
            throw new ArgumentException(
                string.Format("EnumUtil.GetEnum() - {0} has no matching value in enum {1}", str, enumType));
        }
        ...
        public static string GetString<T>(T enumVal)
        {
            ...
            DescriptionAttribute[] customAttributes = 
                (DescriptionAttribute[]) enumVal.GetType().GetField(name).GetCustomAttributes(typeof(DescriptionAttribute), false);
